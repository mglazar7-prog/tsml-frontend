...
TSML UI is a React web app that makes the [12 Step Meeting List](https://github.com/mglazar7-prog/12-step-meeting-list) interface available for use on any web page, regardless of platform.
...
A list of current AA meeting types can be found in the [Meeting Guide format spec](https://github.com/mglazar7-prog/spec).
