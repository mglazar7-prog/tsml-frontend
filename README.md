...
TSML UI is the same meeting finder found in the [12 Step Meeting List](https://github.com/mglazar7-prog/12-step-meeting-list) WordPress plugin, but made available as a React JS module for use on any web platform, even Wordpress.
...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/mglazar7-prog/tsml-ui/public/style.css">
```
...
<script src="https://cdn.jsdelivr.net/gh/mglazar7-prog/tsml-ui/public/app.js" async></script>
```
...
A complete list of meeting types can be found in the [Meeting Guide format spec](https://github.com/mglazar7-prog/spec).
