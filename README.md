...
With only a [Meeting Guide format JSON file](https://github.com/mglazar7-prog/spec) or a Google Sheet, web servants can have the same meeting finder found in the [12 Step Meeting List](https://github.com/mglazar7-prog/12-step-meeting-list) WordPress plugin on any website platform.
...
A full list of meeting types can be found on the [Meeting Guide format spec page](https://github.com/mglazar7-prog/spec). These can be overridden by specifying the code and preferred nomenclature as demonstrated above.
